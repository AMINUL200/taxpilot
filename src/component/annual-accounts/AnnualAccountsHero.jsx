...
import { ArrowRight, PlayCircle, CheckCircle2, FileCheck2, Building2, ClipboardCheck } from "lucide-react";
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1fr_0.95fr] lg:gap-10">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-5 max-w-[520px] text-[15px] leading-6 text-[#687B78] sm:text-base">
              ...
              paperwork and fewer headaches. ComplyTax helps you organise
          ...
          <div className="relative mx-auto w-full max-w-[420px] lg:mx-0 lg:ml-auto">
            <div className="relative rounded-2xl border border-[#DDEAE6] bg-white p-5 shadow-[0_20px_45px_rgba(9,38,58,0.09)]">
              <div className="mb-4 flex items-center justify-between">
                <div>
                  <p className="text-sm font-bold text-[#09263A]">Annual Accounts</p>
                  <p className="text-[11px] text-[#71827F]">ABC Consulting Ltd · Year ending 31 Mar 2026</p>
                </div>
              ...
              <div className="mb-4 flex flex-col gap-2.5">
                <div className="flex items-center justify-between rounded-xl bg-[#F5FCF9] px-3 py-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-[#09263A]">Accounting period</span>
                  </div>
                  <span className="text-[10px] font-semibold text-[#71827F]">Apr 2025 – Mar 2026</span>
                </div>

                <div className="flex items-center justify-between rounded-xl bg-[#F5FCF9] px-3 py-2.5">
                  <div className="flex items-center gap-2">
                    <FileCheck2 className="h-4 w-4 text-[#087F5B]" />
                    <span className="text-xs font-medium text-[#09263A]">Accounts status</span>
                  </div>
                  <CheckCircle2 className="h-4 w-4 text-[#087F5B]" />
                </div>
                ...
                <div className="flex items-center justify-between rounded-xl bg-[#F5FCF9] px-3 py-2.5">
                  <div className="flex items-center gap-2">
                    <ClipboardCheck className="h-4 w-4 text-[#71827F]" />
                    <span className="text-xs font-medium text-[#09263A]">Companies House</span>
                  </div>
                  <span className="text-[10px] font-semibold text-[#71827F]">Prepared</span>
                </div>
              </div>
            ...
            <div className="absolute -left-6 -top-6 hidden items-center gap-2 rounded-xl border border-[#DDEAE6] bg-white px-3 py-2.5 shadow-[0_10px_25px_rgba(9,38,58,0.1)] sm:flex">
              <CheckCircle2 className="h-4 w-4 text-[#087F5B]" />
              <span className="text-xs font-semibold text-[#09263A]">Accounts prepared</span>
            </div>
            ...
            <div className="absolute -bottom-5 -right-4 hidden items-center gap-2 rounded-xl border border-[#DDEAE6] bg-white px-3 py-2.5 shadow-[0_10px_25px_rgba(9,38,58,0.1)] sm:flex">
              <Building2 className="h-4 w-4 text-[#087F5B]" />
              <span className="text-xs font-semibold text-[#09263A]">Companies House</span>
            </div>

            <div className="absolute -right-8 top-1/3 hidden items-center gap-2 rounded-xl border border-[#DDEAE6] bg-white px-3 py-2.5 shadow-[0_10px_25px_rgba(9,38,58,0.1)] lg:flex">
              <FileCheck2 className="h-4 w-4 text-[#087F5B]" />
              <span className="text-xs font-semibold text-[#09263A]">Filing ready</span>
            </div>
          </div>
        </div>
      </div>
