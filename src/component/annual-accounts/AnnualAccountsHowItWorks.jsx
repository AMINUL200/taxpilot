...
const steps = [
  {
    ...
    description: "Enter your company details and provide the financial information needed for your accounts.",
  },
  {
    number: "02",
    title: "Review your accounts",
    description: "Review your figures and make sure everything is ready before filing.",
  },
  {
    number: "03",
    title: "File with Companies House",
    description: "Complete the filing process and keep your accounts organised for your records.",
  },
];
