...
const benefits = [
  "Save time preparing your tax return",
  "Keep income and expenses organised",
  "Reduce manual calculations",
  "See your tax position clearly",
  "Make HMRC filing easier",
  "Manage your tax return online",
];

const statusItems = ["Income", "Expenses", "Tax calculation", "Return preparation", "HMRC filing"];
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div>
            ...
            <p className="mt-4 max-w-[420px] text-sm leading-6 text-[#9FBBB0]">
              Built to keep every part of your tax return organised, from
              your first receipt to your final submission.
            </p>

            {/* Status visual */}
            <div className="mt-8 max-w-[360px] rounded-2xl border border-white/10 bg-white/[0.04] p-5">
              <div className="mb-4 flex items-center justify-between">
                <span className="text-xs font-semibold text-white">Self Assessment</span>
...
export default SelfAssessmentBenefits;