...
const steps = [
  {
    ...
    description: "Provide your company and accounting information.",
  },
  {
    number: "02",
    title: "Review your tax",
    description: "ComplyTax calculates your taxable profit and Corporation Tax liability.",
  },
  {
    number: "03",
    title: "File with HMRC",
    description: "Review your return and submit it electronically.",
  },
];

const CorporationTaxHowItWorks = () => {
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto mb-14 max-w-2xl text-center">
          <h2 className="text-3xl font-bold leading-[1.1] tracking-[-0.03em] text-[#09263A] sm:text-4xl">
            File your Corporation Tax return in 3 simple steps
          </h2>
        </div>
...
export default CorporationTaxHowItWorks;